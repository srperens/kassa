...
const sv: Dict = {
  ...
  'tx.amount.label': 'Belopp ({cur}) — minus för utlägg',
  'tx.time': 'Tid',
  'tx.note': 'Notering',
  ...
  'settings.viewer': 'Endast visning',
  ...
  'settings.allowance.amount': 'Belopp ({cur}) — 0 = av',
...
const en: Dict = {
  ...
  'tx.amount.label': 'Amount ({cur}) — minus for spending',
  'tx.time': 'Time',
  'tx.note': 'Note',
  ...
  'settings.allowance.amount': 'Amount ({cur}) — 0 = off',
